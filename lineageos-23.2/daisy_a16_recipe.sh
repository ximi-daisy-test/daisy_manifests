...
# NOTE:
# kernel tree
# git clone --depth=1 --branch lineage-23.2-no-bpf https://github.com/ximi-daisy-test/android_kernel_xiaomi_msm8953/ kernel/xiaomi/msm8953
...
# git clone --depth=1 --branch lineage-23.2-tweaked https://github.com/ximi-daisy-test/android_hardware_interfaces hardware/interfaces
...
# git clone --depth=1 --branch lineage-23.2-tweaked https://github.com/ximi-daisy-test/android_hardware_qcom-caf_common hardware/qcom-caf/common
